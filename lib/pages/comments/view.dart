...
class CommentsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(backgroundColor: Colors.black,title: Text("${postsModel.title}",style: TextStyle(color: Colors.white),),elevation: 0,),
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                              color: Colors.white,
                              boxShadow: [BoxShadow(color: Colors.black,spreadRadius: 1,blurStyle: BlurStyle.outer,blurRadius: 4)],
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Expanded(
                                      child: Text(
                                        "${snapshot.data![index].email!}",  style: TextStyle(color: Colors.black54,fontSize: 16,fontWeight: FontWeight.w600),
                                      ),
                                    ),
                                  ],
                                ),
                                Row(
                                  children: [
                                    ...
                                    Expanded(
                                      child: Text(
                                        "${snapshot.data![index].body!}",   style: TextStyle(color: Colors.black54,fontSize: 16,fontWeight: FontWeight.w600),
                                      ),
                                    ),
                                  ],
                                ),
